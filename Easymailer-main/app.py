...
if selected == "Main Page":
    ...
    st.title("Welcome to EasyMailer: The AI-Powered Email Assistant")

    # Introduction to the application
    st.write("""
    Easymailer leverages cutting-edge generative AI to help you draft and reply to emails effortlessly. Whether you need to write a formal email to a colleague or craft a friendly note to a friend, Easymailer has you covered.
    """)
    ...
    st.header("How to Use Easymailer")
    st.write("""
    ...
    4. Hit the "Go" button and let Easymailer generate a tailor-made email for you.
    """)
...
if selected == "Write an Email":
    st.image("logo.png", width=100)
    st.title("Easymailer: The AI-Powered Email Assistant")
    st.markdown("""Use Easymailer to craft personalized emails effortlessly. Just fill in the details about the recipient, your relationship, the email's purpose, and the tone you'd like to set. Easymailer will then generate a bespoke email that you can send with confidence.""")
...
if selected == "Reply to an Email":
    st.image("logo.png", width=100)
    st.title("Easymailer: The AI-Powered Email Assistant")
    st.markdown("""Responding to emails has never been easier. Provide Easymailer with the email you've received, your relationship with the sender, and the details you wish to include in your reply. Choose the tone, and Easymailer will generate a thoughtful response for you.""")
...
if selected == "Contact":
    ...
    st.divider()
    st.write(f"🔗 LinkedIn: [Tanish Seth](https://www.linkedin.com/in/tanishseth0510/)")
    st.write(f"👨‍💻 GitHub: [Git-Tanish](https://github.com/tanish0510)")
    st.write(f"🌐 Portfolio: [Tanish Portfolio](https://bento.me/tanish0510)")
    st.divider()
